            ...
            <div class="modal-body">
                <form action="index.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="log" name="log" placeholder="Login" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subname" name="subname" placeholder="Nazwisko" required>
                    </div>
                    <div class="form-group">
                        <label for="land">Miejscowosc:</label>
                        <input type="text" class="form-control" id="land" name="land" placeholder="Miejscowosc" required>
                    </div>
                    <div class="form-group">
                        <label for="tel">Telefon:</label>
                        <input type="number" class="form-control" id="tel" name="tel" placeholder="XXXXXXXXX" required>
                    </div>
